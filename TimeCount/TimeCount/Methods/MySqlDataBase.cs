   ...
   public class MySqlDataBase 
    {
        ...
        static MySqlConnection Connection = new MySqlConnection(Properties.Settings.Default.MySqlConnString);
       ...
       // MessageBox.Show(Crypto8.Cryptography.Encrypt("lol", true) );
        ...
        internal void SignIn()
        {
            ...
            using (_MySqlCommand = new MySqlCommand("SELECT * FROM TimeCounterUsers WHERE UserName = '" + _AccountViewModel.UserName + "' AND Password='" + _AccountViewModel.Password + "';", Connection))
            {
                try
                {
       ...
       public void CreateNewUser()
        {
           ...
           //ERROR MEANS THAT THIS USER EXIST
            ...
            using (_MySqlCommand = new MySqlCommand("INSERT INTO TimeCounterUsers (UserName, Password, UserInformations) VALUES('" + _AccountCreationViewModel.UserName + "', '" + _AccountCreationViewModel.Password + "', '" + UserInformation + "')", Connection))
            {
